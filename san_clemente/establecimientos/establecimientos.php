...
<div class="contenedor">
    ...
    $sentencia_select=$con->prepare('SELECT *FROM establecimientos_san_clemente ORDER BY id DESC');
    ...
    if(isset($_POST['btn_buscar3'])){
        ...
        $select_buscar=$con->prepare('
            SELECT *FROM establecimiento_san_clemente WHERE informal LIKE :campo;'
        );

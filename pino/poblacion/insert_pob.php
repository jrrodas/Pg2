...
if(!empty($hombres) && !empty($mujeres) && !empty($jovenes) && !empty($adultos) && !empty($adulto_m) && !empty($total) && !empty($periodo) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO poblacion_pino(hombres,mujeres,jovenes,adultos,adulto_m,total,periodo) VALUES(:hombres,:mujeres,:jovenes,:adultos,:adulto_m,:total,:periodo)');

...
<div class="contenedor">
    ...
    $sentencia_select=$con->prepare('SELECT *FROM establecimientos_cacao_viejo ORDER BY id DESC');
    ...
    if(isset($_POST['btn_buscar3'])){
        ...
        $select_buscar=$con->prepare('
            SELECT *FROM establecimiento_cacao_viejo WHERE informal LIKE :campo;'
        );

...
if(!empty($cantidad) && !empty($conpiso) && !empty($sinpiso) && !empty($blok) && !empty($lamina) && !empty($terraza) && !empty($periodo) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO vivienda_chical(cantidad,conpiso,sinpiso,blok,lamina,terraza,periodo) VALUES(:cantidad,:conpiso,:sinpiso,:blok,:lamina,:terraza,:periodo)');

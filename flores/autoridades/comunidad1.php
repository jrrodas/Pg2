...
<?php
    ...
    $sentencia_select=$con->prepare('SELECT *FROM autoridades_flores ORDER BY id DESC');
    ...
    if(isset($_POST['btn_buscar'])){
        ...
        $select_buscar=$con->prepare('
            SELECT *FROM autoridades_flores WHERE nombres LIKE :campo OR direccion LIKE :campo OR cargo LIKE :campo;'
        );

...
if(!empty($nombre) && !empty($cobertura) && !empty($calidad) && !empty($disponibilidad) && !empty($empleados) && !empty($publico) && !empty($privado) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO servicios_guapinol(nombre,cobertura,calidad,disponibilidad,empleados,publico,privado) VALUES(:nombre,:cobertura,:calidad,:disponibilidad,:empleados,:publico,:privado)');

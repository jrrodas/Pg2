...
<div class="contenedor">
    ...
    $sentencia_select=$con->prepare('SELECT *FROM establecimientos_buena_vista ORDER BY id DESC');
    ...
    if(isset($_POST['btn_buscar3'])){
        ...
        $select_buscar=$con->prepare('
            SELECT *FROM establecimiento_buena_vista WHERE informal LIKE :campo;'
        );

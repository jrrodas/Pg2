...
<div class="contenedor">
    ...
    $sentencia_select=$con->prepare('SELECT *FROM establecimientos_el_calvario ORDER BY id DESC');
    ...
    if(isset($_POST['btn_buscar3'])){
        ...
        $select_buscar=$con->prepare('
            SELECT *FROM establecimiento_el_calvario WHERE informal LIKE :campo;'
        );

...
<div class="contenedor">
    ...
    $sentencia_select=$con->prepare('SELECT *FROM establecimientos_el_pacayal ORDER BY id DESC');
    ...
    if(isset($_POST['btn_buscar3'])){
        ...
        $select_buscar=$con->prepare('
            SELECT *FROM establecimientos_el_pacayal WHERE informal LIKE :campo;'
        );

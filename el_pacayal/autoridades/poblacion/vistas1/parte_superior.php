      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="comunidad1.php">autoridades_el_moral</a>
            <a class="collapse-item" href="comunidad2.php">Población</a>
            <a class="collapse-item" href="comunidad2.php">Servicios</a>

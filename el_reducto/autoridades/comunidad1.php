...
<?php
    ...
    $sentencia_select=$con->prepare('SELECT *FROM autoridades_el_reducto ORDER BY id DESC');
    ...
    if(isset($_POST['btn_buscar'])){
        ...
        $select_buscar=$con->prepare('
            SELECT *FROM autoridades_el_reducto WHERE nombres LIKE :campo OR direccion LIKE :campo OR cargo LIKE :campo;'
        );

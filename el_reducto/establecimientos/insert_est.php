...
if(!empty($comercio) && !empty($cantidad) && !empty($tamano) && !empty($disponibilidad) && !empty($empleados) && !empty($formal) && !empty($informal) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO establecimientos_el_reducto(comercio,cantidad,tamano,disponibilidad,empleados,formal,informal) VALUES(:comercio,:cantidad,:tamano,:disponibilidad,:empleados,:formal,:informal)');

<?php require_once "../comunidad2/vistas1/parte_superior.php"?>
...
if(!empty($nombres) && !empty($cargo) && !empty($telefono) && !empty($dpi) && !empty($direccion) && !empty($vigencia) && !empty($correo) ){
			if(!filter_var($correo,FILTER_VALIDATE_EMAIL)){
				...
				$consulta_insert=$con->prepare('INSERT INTO autoridades(nombres,cargo,telefono,dpi,direccion,vigencia,correo) VALUES(:nombres,:cargo,:telefono,:dpi,:direccion,:vigencia,:correo)');
    ...
    <h1>Agregar Datos</h1>
		<form action="" method="post">
			...
			<div class="btn__group">
				<a href="comunidad2.php" class="btn btn__danger">Cancelar</a>
				<a href="comunidad2.php" class="btn btn__danger">Regresar</a>
...
<?php require_once "../comunidad2/vistas1/parte_inferior.php"?>
...
<?php
    ...
    $sentencia_select=$con->prepare('SELECT *FROM establecimientos ORDER BY id DESC');
    ...
    if(isset($_POST['btn_buscar'])){
        ...
        SELECT *FROM poblacion WHERE informal LIKE :campo;'
        );
...
<div class="contenedor">
    ...
    if(isset($_POST['btn_buscar3'])){
        ...
        $select_buscar=$con->prepare('
            SELECT *FROM establecimientos WHERE informal LIKE :campo;'
        );

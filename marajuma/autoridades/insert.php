...
if(!empty($nombres) && !empty($cargo) && !empty($telefono) && !empty($dpi) && !empty($direccion) && !empty($vigencia) && !empty($correo) ){
			if(!filter_var($correo,FILTER_VALIDATE_EMAIL)){
				...
				$consulta_insert=$con->prepare('INSERT INTO autoridades_marajuma(nombres,cargo,telefono,dpi,direccion,vigencia,correo) VALUES(:nombres,:cargo,:telefono,:dpi,:direccion,:vigencia,:correo)');
